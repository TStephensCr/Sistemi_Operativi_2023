...
kernel : ./phase1/p1test.o ./phase1/msg.o ./phase1/pcb.o ./phase2/p2test.o ./phase2/initial.o ./phase2/scheduler.o ./phase2/utile.o crtso.o libumps.o
	$(LD) -o $@ $^ $(LDFLAGS)

clean :
	-rm -f *.o ./phase2/*.o kernel kernel.*.umps
